...
@Data
public class LearningPlanRecordDto {
    ...
    /** 内训额外参数 */
    @Valid
    public List<LearningPlanInsideTrainingDto> insideTraining;
...
//    public List<LearningPlanUnlockDetailDto> unlockDetail;
//
////        /** 选修范围 */
...
//    public List<LearningPlanShiftRangeDto> shiftRange;
//
//    /** 报名提示 */
...
//    public List<LearningPlanEnrollExtraConDto> enrollExtraCon;
//
//    /** 报名设置 */
//    @JsonProperty("enroll_setting")
//    public List<LearningPlanEnrollSettingDto> enrollSetting;
//
//    /** 是否启用报名表单 */
...
//    public List<LearningPlanEnrollFormDto> enrollForm;
//
//    /** h5按钮控制 */
//    @JsonProperty("app_setting")
//    public List<LearningPlanAppSettingDto> appSetting;
//
//    /** 颁发证书/结业条件 */
//    @JsonProperty("certificate_condition")
//    public List<LearningPlanCertificateConditionDto> certificateCondition;
//
//    /** 开启自动结业 0-否 1-是 */
...
//    public List<LearningPlanTouristSettingDto> touristSetting;
//
//    /** 设置 */
//    public List<LearningPlanSettingsDto> settings;
//
////        /** 所属组织 */
...
//
//    /** 模板分类 */
//    public List<LearningCategoryDto> category;
//
//    /** 是否是默认封面 0-否 1-是 */
